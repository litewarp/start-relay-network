// Cribbed from https://github.com/apollographql/apollo-client-integrations/blob/main/packages/client-react-streaming/src/DataTransportAbstraction/backpressuredCallback.ts
...
export type BackPressureCallback<T> = ReturnType<typeof createBackpressuredCallback<T>>;
